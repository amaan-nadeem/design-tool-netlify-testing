...
export const HorizontalAlign: React.FC<Icon> = ({ size = 1, color }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={sizeFactor * size}
    ...
    >
      <path
        fill={color}
        fillRule="evenodd"
        d="M0 .5h1v2h9v-2h1v5h-1v-2H1v2H0v-5z"
        clipRule="evenodd"
      ></path>
    </svg>
  );
...
export const VerticalAlign: React.FC<Icon> = ({ size = 1, color }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={sizeFactor * size}
    ...
    >
      <path
        fill={color}
        fillRule="evenodd"
        d="M0 11.5v-1h2v-9H0v-1h5v1H3v9h2v1H0z"
        clipRule="evenodd"
      ></path>
    </svg>
  );
...
export const Checkmark: React.FC<Icon> = ({ size = 1, color }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={sizeFactor * size}
